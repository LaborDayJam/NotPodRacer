        ...
        if (trgr.Success)
        {
            ...
            // Translation:
            {
                ...
                else
                {
					if(vec.z > maxDepth)
						maxDepth = vec.z;
					else if(vec.z < minDepth)
						minDepth = vec.z;

					handDepth = vec.z;
					this.gameObject.transform.localPosition = new Vector3(transform.localPosition.x, transform.localPosition.y, vec.z);
                }
            }
        }
    }
